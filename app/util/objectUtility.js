const objectify = async (data)=>{
    let selection_object = {rollno:false, first_name:false, last_name:false, middle_name:false, email:false, phone_number:false, gender:false, github:false, linkedin:false,no_of_offers:false,password:false, photo:false, department:false, batch:false, rait_email:false,student_skillset:false,student_placement_details:false,student_experience:false,other_info:false,academic_info:false};
    ...
    selection_object.student_placement_details = final_select_object.student_placement_details;
...
const other_tables = async (select_object)=>{
    let stud_skillset = {select:{certificate:false, career_obj:false, acad_achievement:false}};
    
    let stud_placement_details = {select:{package:false, placed_org:false,offer_letter:false}};
    
    let stud_experience = {select:{technologies:false,pref_lang:false,project:false,intership:false}};
    
    let oth_info = {select:{hobbies:false,pos_of_res:false,extracuricular:false}};
    
    let acad_info = {select:{tenth_percent:false,twelveth_percent:false,sem_pointer:false,cgpa:false,be_percent:false}};
    ...
    for( var key in select_object)
    {
        if(key == "acad_achievement"||key == "career_obj"||key == "certificate"){
        ...
        if(key=="intership"||key=="project"||key=="pref_lang"||key=="technologies"){
        ...
        if(key=="tenth_percent"||key=="twelveth_percent"||key=="sem_pointer"||key=="cgpa"||key=="be_percent"){
    ...
    for( var key in final_select_object){
